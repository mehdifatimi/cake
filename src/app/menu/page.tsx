...
const menuItems = [
  { id: 1, name: "Signature Macarons", description: "Box of 12 artisan macarons with seasonal flavors.", price: "$32.00", category: "Macarons", image: "https://images.unsplash.com/photo-1569864358642-9d16197022c3?q=80&w=1000" },
  ...
  { id: 4, name: "Dark Chocolate Truffles", description: "Hand-rolled ganache coated in 70% cocoa powder.", price: "$28.00", category: "Chocolates", image: "https://images.unsplash.com/photo-1548907040-4baa42d100fe?q=80&w=1000" },
  ...
  { id: 6, name: "Custom Wedding Cake", description: "Bespoke tiered design tailored to your celebration.", price: "From $350", category: "Cakes", image: "https://images.unsplash.com/photo-1535254973040-607b474cb8c2?q=80&w=1000" },
];
      ...
      <section className="py-24 bg-brand-cream">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6">Our Exquisite <span className="italic text-gold-gradient">Creations</span></h1>
